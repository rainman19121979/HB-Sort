...
public class FirstRunServiceTests : IDisposable
{
    ...
    private sealed class StubBlCache : IBlCacheRepository
    {
        ...
        public Task<PriceResult?> GetCachedPriceAsync(string itemType, string itemNo, int colorId, string guideType, string newOrUsed, string region, string currency, int staleDays, CancellationToken ct = default, string vatMode = "N") => throw new NotImplementedException();
        public Task UpsertPriceAsync(string itemType, string itemNo, int colorId, string guideType, string newOrUsed, string region, string currency, PriceResult price, CancellationToken ct = default, string vatMode = "N") => throw new NotImplementedException();
