...
public class BlBulkImportEtagTests
{
    ...
    private sealed class StubCacheRepo : IBlCacheRepository
    {
        ...
        public Task<HBSort.Core.Models.Pricing.PriceResult?> GetCachedPriceAsync(string itemType, string itemNo, int colorId, string guideType, string newOrUsed, string region, string currency, int staleDays, CancellationToken ct = default, string vatMode = "N") => throw new NotImplementedException();
        public Task UpsertPriceAsync(string itemType, string itemNo, int colorId, string guideType, string newOrUsed, string region, string currency, HBSort.Core.Models.Pricing.PriceResult price, CancellationToken ct = default, string vatMode = "N") => throw new NotImplementedException();
        public Task<HBSort.Core.Models.Pricing.CachedPriceLookup?> GetCachedPriceWithStaleFlagAsync(string itemType, string itemNo, int colorId, string guideType, string newOrUsed, string region, string currency, int ttlDays, CancellationToken ct = default, string vatMode = "N") => throw new NotImplementedException();
